 ...
 */
export declare function addGlobalError(details: StatusDetails): Promise<void>;
/**
 ...
 */
export declare function addGlobalAttachment(name: string, content: string | Buffer, contentType?: ContentType | string): Promise<void>;
/**
 ...
 */
export declare function addGlobalAttachmentFromPath(name: string, path: string, contentType?: ContentType | string): Promise<void>;
/**
...
declare const _default: {
    ...
    addGlobalAttachment: typeof addGlobalAttachment;
    addGlobalAttachmentFromPath: typeof addGlobalAttachmentFromPath;
