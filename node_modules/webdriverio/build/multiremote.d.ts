...
export default class MultiRemote {
    ...
    sessionId?: string;
    usedUnstableSelectAPIOnElementScope: boolean;
    /**
     ...
     * ```
     */
    static elementWrapper(instances: Record<string, WebdriverIO.Browser>, result: unknown, propertiesObject: Record<string, PropertyDescriptor>, scope: MultiRemote, selector?: string): WebdriverIO.MultiRemoteElement;
    /**
     * handle commands for multiremote instances
     */
    commandWrapper(commandName: keyof (ProtocolCommands & BrowserCommandsType) & 'getInstance' & 'unstable_select'): ((this: Record<string, WebdriverIO.Browser | WebdriverIO.Element>, browserName: string) => WebdriverIO.Browser | WebdriverIO.Element) | ((this: Record<string, WebdriverIO.Browser | WebdriverIO.Element>, instanceNames: string | string[]) => MultiRemote) | ((...args: unknown[]) => Promise<unknown>);
}
/**
